      ...
      <div className="flex gap-x-3 w-full justify-start sm:justify-between">
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <div className="flex gap-1">
            ...
            <p className="relative bottom-1 left-1 md:left-1.5 w-5 h-5 font-semibold text-natural_5">
              -
            </p>
        ...
        <div className="flex self-end ml-1">
          <img
            src={gMeet}
            className="w-5 h-5 self-center mr-1"
          ...
          <a
            ...
            className="text-natural_5 text-sm"
          >
            Google Meet
          </a>
        </div>
