                      ...
                      <div className="flex justify-between ">
                        <div className="flex items-center">
                          ...
                          <label
                            ...
                            className="ml-4 text-sm font-medium text-natural_3"
                          >
                            {option.name}
                          </label>
                        </div>
                        <p className="flex bg-natural_4 text-natural_5 rounded-full px-2.5 py-1 dark:bg-black_3">
                          {option.est_count}
                        </p>
                      </div>
                    </li>
                      ...
                      <div className="flex justify-between ">
                        <div className="flex items-center">
                          <input
                            ...
                            type="checkbox"
                            onChange={(e) =>
                              handleCategoriesSelect(e, option.value)
                            }
                            className="w-4 h-4 text-natural_3 bg-gray-100 border-gray-300 rounded"
                          />
                          <label
                      ...
                      <div className="flex justify-between ">
                        <div className="flex items-center">
                          <input
                            ...
                            type="checkbox"
                            onChange={(e) =>
                              handleSalarySelect(e, option.bounds)
                            }
                            className="w-4 h-4 text-natural_3 bg-gray-100 border-gray-300 rounded"
                          />
                          <label
