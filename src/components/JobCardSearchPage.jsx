    ...
    <div className="bg-white rounded-md px-5 py-5 border flex flex-col my-4 dark:bg-black_2 dark:border-none">
      ...
      <div className="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2 my-5">
        ...
        <div className="flex flex-row items-start space-x-3 md:space-x-10">
          ...
          <p className="bg-natural_4 font-bold text-natural_5 rounded-sm text-center py-1 dark:bg-black_3">
            {job.job_is_remote ? "Remote Work" : null}
          </p>
        </div>
        {/* 4th line right side */}
        <div className="flex justify-between sm:items-end">
          <button
            type="button"
            className="bg-secondary hover:bg-primary text-natural_3 px-6 py-2.5 mx-4 rounded-lg dark:bg-black_3"
          >
            Message
          </button>
          <button
            type="button"
            className="bg-primary hover:bg-natural_5 text-white px-6 py-2.5 mx-4 rounded-lg"
          >
            Apply now
          </button>
        </div>
