...
const CompanyCard = ({ job }) => {
  ...
  return (
    <div className="bg-white dark:bg-black_2 p-3 px-5 rounded-md drop-shadow-sm flex flex-col gap-y-3">
      ...
      <div className="flex flex-col gap-1">
        <p className="rounded-md text-natural_5 flex gap-x-2 text-sm items-center">
      ...
      <button
        type="button"
        className="bg-[#F5F5F8] dark:bg-black_3 hover:secondary font-semibold text-sm text-natural p-3 rounded-lg"
      >
        Visit Now
      </button>
    </div>
