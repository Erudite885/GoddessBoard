        ...
        <div className="">
            ...
            <div>
              {maxSalary ? (
                <p className="font-bold text-white">
                  {" "}
                  {maxSalary}
                  <span className="text-natural text-sm font-normal">/ Hr</span>
                </p>
              ) : (
                "NA"
              )}
          ...
          >
            ...
            <div className="flex items-center align-middle mt-2">
              <a
                href="/"
                className="border mr-4 p-2 rounded-md border-natural border-opacity-10"
              >
